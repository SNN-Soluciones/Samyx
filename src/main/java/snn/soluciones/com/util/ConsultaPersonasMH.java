...
public class ConsultaPersonasMH {
  @RequestMapping(value = {"/consulta-personas-mh"}, method = {RequestMethod.GET}, produces = {"application/json"})
  public String consulta(@RequestParam(name = "identificacion", required = false) String identificacion) throws Exception {
    String response = "";
    String d = "";
    try {
