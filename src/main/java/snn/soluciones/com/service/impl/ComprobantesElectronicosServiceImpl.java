...
public class ComprobantesElectronicosServiceImpl implements IComprobantesElectronicosService {
  ...
  @Transactional
  public void UpdateComprobantesElectronicos(String responseCodeSend, String indEstado, Integer reconsultas, Long id) {
    this._comprobantesElectronicosDao.UpdateComprobantesElectronicos(responseCodeSend, indEstado, reconsultas, id);
  }
  
  public Page<ComprobantesElectronicos> findAllComprobanteByEmisor(String identificacionEmisor, String q, Pageable pageable) {
    return this._comprobantesElectronicosDao.findAllComprobanteByEmisor(identificacionEmisor, q, pageable);
  }
  
  @Transactional
  public void UpdateComprobantesElectronicosApi(String responseCodeSend, String indEstado, String emailDistribucion, Integer reconsultas, Long id) {
    this._comprobantesElectronicosDao.UpdateComprobantesElectronicosApi(responseCodeSend, indEstado, emailDistribucion, reconsultas, id);
  }
}
