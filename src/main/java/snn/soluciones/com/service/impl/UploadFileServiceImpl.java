...
import snn.soluciones.com.service.interfaces.IUploadFileService;
import java.io.File;
...
public class UploadFileServiceImpl implements IUploadFileService {
  ...
  public void init() throws IOException {
    Files.createDirectory(Paths.get("/opt/uploads/biopasos", new String[0]), (FileAttribute<?>[])new FileAttribute[0]);
  }
}
