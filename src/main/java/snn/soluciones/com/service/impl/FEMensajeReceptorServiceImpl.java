...
import snn.soluciones.com.models.dao.IFEMensajeReceptorDao;
...
public class FEMensajeReceptorServiceImpl implements IFEMensajeReceptorService {
  ...
  public List<FEMensajeReceptor> findAllMR(Long emisorId, Date f1, Date f2, List<String> estadoHacienda, List<String> condicionImpuesto, List<String> m, String actividad) {
    return this._dao.findAllMR(emisorId, f1, f2, estadoHacienda, condicionImpuesto, m, actividad);
  }
  
  public List<FEMensajeReceptor> findAllMRFechaEmision(Long emisorId, Date f1, Date f2, List<String> estadoHacienda, List<String> condicionImpuesto, List<String> m, String actividad) {
    return this._dao.findAllMRFechaEmision(emisorId, f1, f2, estadoHacienda, condicionImpuesto, m, actividad);
  }
  
  @Transactional
  public void aplicarFacturaCompra(Usuario usuario, String estadoInventario, Date fechaAplicacionInventario, Long idMr, Long emisorId) {
