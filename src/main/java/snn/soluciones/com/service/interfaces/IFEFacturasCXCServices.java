...
public interface IFEFacturasCXCServices {
  ...
  Page<FEFacturasCXC> findAllCXCCanceladas(Long paramLong, String paramString1, String paramString2, Pageable paramPageable);
  ...
  Double findAllCXCPagadas(Long paramLong1, String paramString1, Long paramLong2, Date paramDate, String paramString2);
