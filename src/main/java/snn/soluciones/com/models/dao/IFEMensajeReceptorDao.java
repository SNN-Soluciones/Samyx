...
public interface IFEMensajeReceptorDao extends JpaRepository<FEMensajeReceptor, Long> {
  ...
  List<FEMensajeReceptor> findAllMR(@Param("emisorId") Long paramLong, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("estadoHacienda") List<String> paramList1, @Param("condicionImpuesto") List<String> paramList2, @Param("moneda") List<String> paramList3, @Param("actividad") String paramString);
  ...
  List<FEMensajeReceptor> findAllMRFechaEmision(@Param("emisorId") Long paramLong, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("estadoHacienda") List<String> paramList1, @Param("condicionImpuesto") List<String> paramList2, @Param("moneda") List<String> paramList3, @Param("actividad") String paramString);
  ...
  void aplicarFacturaCompra(Usuario paramUsuario, String paramString, Date paramDate, Long paramLong1, Long paramLong2);
}
