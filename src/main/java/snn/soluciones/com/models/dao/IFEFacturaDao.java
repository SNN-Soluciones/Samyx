...
""")
  ...
  List<FEFactura> reporteDocumentosGenerados(@Param("emisorId") Long paramLong, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("actividad") String paramString);
  ...
  List<FEFactura> reporteDocumentosGeneradosBySucursalAndTerminal(@Param("emisorId") Long paramLong1, @Param("sucursal") Long paramLong2, @Param("terminal") Long paramLong3, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("actividad") String paramString);
  ...
  List<FEFactura> reporteDocumentosGeneradosByUser(@Param("emisorId") Long paramLong1, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("actividad") String paramString, @Param("usuario") Long paramLong2);
  ...
  List<FEFactura> reporteDocumentosGeneradosByUserBySucursalAndTerminal(@Param("emisorId") Long paramLong1, @Param("sucursal") Long paramLong2, @Param("terminal") Long paramLong3, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("actividad") String paramString, @Param("usuario") Long paramLong4);
  ...
  List<FEFactura> reporteDocumentosGeneradosAll(@Param("emisorId") Long paramLong, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5);
  
  @Query("SELECT c FROM FEFactura c WHERE c.emisor.id = :emisorId AND (c.fechaEmisionFe BETWEEN :f1 AND :f2 AND c.tipoDocumento IN(:td) AND c.estado IN(:estado) AND c.condVenta IN(:cv) AND c.medioPago IN(:mp) AND c.moneda.simboloMoneda IN(:m))")
  List<FEFactura> reporteDocumentosGeneradosFEC(@Param("emisorId") Long paramLong, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5);
  ...
  List<FEFactura> reporteDocumentosGeneradosFECBySucursalAndTerminal(@Param("emisorId") Long paramLong1, @Param("sucursal") Long paramLong2, @Param("terminal") Long paramLong3, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5);
  ...
  List<FEFactura> reporteDocumentosGeneradosFECByUser(@Param("emisorId") Long paramLong1, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("usuario") Long paramLong2);
  ...
  List<FEFactura> reporteDocumentosGeneradosFECByUserBySucursalAndTerminal(@Param("emisorId") Long paramLong1, @Param("sucursal") Long paramLong2, @Param("terminal") Long paramLong3, @Param("f1") Date paramDate1, @Param("f2") Date paramDate2, @Param("td") List<String> paramList1, @Param("estado") List<String> paramList2, @Param("cv") List<String> paramList3, @Param("mp") List<String> paramList4, @Param("m") List<String> paramList5, @Param("usuario") Long paramLong4);
  ...
  Double totalVentasByCondicionVentaAndMedioPago(Long paramLong1, Long paramLong2, String paramString1, String paramString2, Date paramDate, String paramString3, List<String> paramList);
  ...
  Double totalVentasByCondicionVentaCredito(Long paramLong1, Long paramLong2, String paramString1, Date paramDate, String paramString2);
}
