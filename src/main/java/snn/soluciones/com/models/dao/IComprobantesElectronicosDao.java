...
public interface IComprobantesElectronicosDao extends JpaRepository<ComprobantesElectronicos, Long> {
  ...
  Page<ComprobantesElectronicos> findAllComprobanteByEmisor(String paramString1, String paramString2, Pageable paramPageable);
  ...
  void UpdateComprobantesElectronicosApi(String paramString1, String paramString2, String paramString3, Integer paramInteger, Long paramLong);
}
