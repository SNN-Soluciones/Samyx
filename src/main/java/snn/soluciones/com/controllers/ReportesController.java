...
import snn.soluciones.com.service.interfaces.IEmpresaUsuarioAccesoService;
    ...
    return (View)new AbstractXlsxView() {
        protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
          if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
            ...
            header.createCell(0).setCellValue("Nde factura");
            ...
            header.createCell(8).setCellValue("Condiciventa");
            ...
            header.createCell(46).setCellValue("Cactividad económica");
  ...
  public void reporteProductos(HttpServletResponse response, HttpSession session, @RequestParam(name = "actividad", required = false) String actividad, @RequestParam(name = "proveedor", required = false) String proveedor, @RequestParam(name = "C", required = false) String c, @RequestParam(name = "sucursal", required = false) String sucursal, @RequestParam(name = "terminal", required = false) String terminal, @RequestParam(name = "f1", required = false) String f1, @RequestParam(name = "f2", required = false) String f2) throws JRException, IOException, SQLException, ParseException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      ...
      try {
        ...
        jRXlsxExporter.setExporterOutput(
            (OutputStreamExporterOutput) new SimpleOutputStreamExporterOutput((OutputStream)servletOutputStream));
    ...
    return (View)new AbstractXlsxView() {
        protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
          if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
            ...
            header.createCell(38).setCellValue("Detalle aceptació");
            header.getCell(0).setCellStyle((CellStyle)style);
            header.getCell(1).setCellStyle((CellStyle)style);
            header.getCell(2).setCellStyle((CellStyle)style);
            header.getCell(3).setCellStyle((CellStyle)style);
            ...
            for (Map<String, Object> r : reporteCompras) {
              ...
              if (r.get("moneda").toString().equalsIgnoreCase("USD"))
                tipoCambioMonedaFecha = Double.valueOf(Double.parseDouble(r.get("tipo_cambio").toString())); 
              cell = row.createCell(0);
              ...
              cell = row.createCell(10);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida1").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivaReducida1 = Double.valueOf(ivaReducida1.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida1").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivaReducida1 = Double.valueOf(ivaReducida1.doubleValue() + 0.0D);
              ...
              cell = row.createCell(11);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida1").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvaReducida1 = Double.valueOf(montoIvaReducida1.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida1").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvaReducida1 = Double.valueOf(montoIvaReducida1.doubleValue() + 0.0D);
              ...
              cell = row.createCell(12);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida2").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivaReducida2 = Double.valueOf(ivaReducida2.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida2").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivaReducida2 = Double.valueOf(ivaReducida2.doubleValue() + 0.0D);
              ...
              cell = row.createCell(13);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida2").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvaReducida2 = Double.valueOf(montoIvaReducida2.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida2").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvaReducida2 = Double.valueOf(montoIvaReducida2.doubleValue() + 0.0D);
              ...
              cell = row.createCell(14);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida4").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivaReducida4 = Double.valueOf(ivaReducida4.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivaReducida4").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivaReducida4 = Double.valueOf(ivaReducida4.doubleValue() + 0.0D);
              ...
              cell = row.createCell(15);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida4").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvaReducida4 = Double.valueOf(montoIvaReducida4.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvaReducida4").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvaReducida4 = Double.valueOf(montoIvaReducida4.doubleValue() + 0.0D);
              ...
              cell = row.createCell(16);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio0").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivatransitorio0 = Double.valueOf(ivatransitorio0.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio0").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivatransitorio0 = Double.valueOf(ivatransitorio0.doubleValue() + 0.0D);
              ...
              cell = row.createCell(17);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio0").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvatransitorio0 = Double.valueOf(montoIvatransitorio0.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio0").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvatransitorio0 = Double.valueOf(montoIvatransitorio0.doubleValue() + 0.0D);
              ...
              cell = row.createCell(18);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio4").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivatransitorio4 = Double.valueOf(ivatransitorio4.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio4").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivatransitorio4 = Double.valueOf(ivatransitorio4.doubleValue() + 0.0D);
              ...
              cell = row.createCell(19);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio4").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvatransitorio4 = Double.valueOf(montoIvatransitorio4.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio4").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvatransitorio4 = Double.valueOf(montoIvatransitorio4.doubleValue() + 0.0D);
              ...
              cell = row.createCell(20);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio8").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivatransitorio8 = Double.valueOf(ivatransitorio8.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivatransitorio8").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivatransitorio8 = Double.valueOf(ivatransitorio8.doubleValue() + 0.0D);
              ...
              cell = row.createCell(21);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio8").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvatransitorio8 = Double.valueOf(montoIvatransitorio8.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvatransitorio8").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvatransitorio8 = Double.valueOf(montoIvatransitorio8.doubleValue() + 0.0D);
              ...
              cell = row.createCell(22);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivageneral13").toString()))), tipoCambioMonedaFecha).doubleValue());
                ivageneral13 = Double.valueOf(ivageneral13.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("ivageneral13").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                ivageneral13 = Double.valueOf(ivageneral13.doubleValue() + 0.0D);
              ...
              cell = row.createCell(23);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvageneral13").toString()))), tipoCambioMonedaFecha).doubleValue());
                montoIvageneral13 = Double.valueOf(montoIvageneral13.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("montoIvageneral13").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
                montoIvageneral13 = Double.valueOf(montoIvageneral13.doubleValue() + 0.0D);
              ...
              cell = row.createCell(24);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_gravados").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalServGravados = Double.valueOf(totalServGravados.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_gravados").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(25);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_exentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalServExentos = Double.valueOf(totalServExentos.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_exentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(26);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_exonerado").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalSerExonerado = Double.valueOf(totalSerExonerado.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_serv_exonerado").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(27);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_gravadas").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalMerGravadas = Double.valueOf(totalMerGravadas.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_gravadas").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(28);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_exentas").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalMerExenta = Double.valueOf(totalMerExenta.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_exentas").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(29);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_exonerada").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalMerExonerada = Double.valueOf(totalMerExonerada.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_merc_exonerada").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(30);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_gravados").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalGravados = Double.valueOf(totalGravados.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_gravados").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(31);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_exentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalExentos = Double.valueOf(totalExentos.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_exentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(32);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_exonerado").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalExonerado = Double.valueOf(totalExonerado.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_exonerado").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(33);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_ventas").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalVenta = Double.valueOf(totalVenta.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_ventas").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(34);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_descuentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                descuentos = Double.valueOf(descuentos.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_descuentos").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
              ...
              cell = row.createCell(35);
              try {
                cell.setCellValue(ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_venta_neta").toString()))), tipoCambioMonedaFecha).doubleValue());
                totalVentaNeta = Double.valueOf(totalVentaNeta.doubleValue() + ReportesController.this.tipoCambioReporteCompras(r.get("moneda").toString(), sr, ReportesController.this.montoFinal(clave, Double.valueOf(Double.parseDouble(r.get("total_venta_neta").toString()))), tipoCambioMonedaFecha).doubleValue());
                if (clave.equalsIgnoreCase("3"))
                  cell.setCellStyle((CellStyle)styleBackground); 
              } catch (Exception e2) {
            ...
            tipoCambioMonedaFecha = Double.valueOf(0.0D);
          } 
        }
      };
  }
  ...
  public String CondicionVenta(String c) {
    ...
    switch (c) {
      ...
      case "4":
        ...
        break;
      case "5":
        response = "Arrendamiento con opcide compra";
        break;
      case "6":
        response = "Arrendamiento en funcifinanciera";
        break;
      case "7":
        response = "Cobro a favor de un tercero";
        break;
      case "8":
        response = "Servicios prestados al Estado a credito";
        break;
      case "9":
        response = "Pago del servicios prestado al Estado ";
        break;
      case "99":
        response = "Otros (se debe indicar la condicide la venta)";
        break;
    } 
    return response;
  }
  ...
  public String MedioDePago(String m) {
    ...
    switch (m) {
      ...
      case "3":
        ...
        break;
      case "4":
        response = "Transferencia - depbancario";
        break;
      case "5":
