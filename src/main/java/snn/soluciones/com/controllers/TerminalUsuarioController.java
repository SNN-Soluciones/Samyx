...
public class TerminalUsuarioController {
  ...
  public ResponseEntity<?> FormSaveNuevoAcceso(Model model, CTerminalUsuario terminalUsuario, @RequestParam(name = "sucursal", required = false) Long sucursal) {
  ...
  public ResponseEntity<?> FormSaveNuevoAcceso(@RequestParam(name = "id", required = false) Long id, @RequestParam(name = "s", required = false) Long s) {
    Map<String, Object> response = new HashMap<>();
    try {
