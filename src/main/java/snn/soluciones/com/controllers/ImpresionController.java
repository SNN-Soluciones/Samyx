...
public class ImpresionController {
  ...
  @ResponseBody
  public void imprimirFacturaImagen(HttpServletResponse response, HttpSession session, @PathVariable("clave") String clave, @RequestParam(name = "print", required = false) String print) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      ...
      if (factura != null) {
        ...
        parameter.put("RESOLUCION", "“mediante resolución N˚ DGT-R-033-2019 del 20/06/2019“");
        ...
        try {
          ...
          response.setHeader("Content-Disposition", "filename=" + factura.getTipoDocumento() + "-" + factura.getClave() + ".png");
      ...
      if (factura != null) {
        ...
        try {
          ...
          if (bytes != null && bytes.length > 0) {
            ...
            response.setHeader("Content-Disposition", "filename=" + factura.getTipoDocumento() + "-" + factura.getClave() + ".pdf");
  ...
  private void PrintReportToPrinter(JasperPrint jp, String impresora) throws JRException {
    ...
    exporter.setParameter((JRExporterParameter)JRPrintServiceExporterParameter.PRINT_REQUEST_ATTRIBUTE_SET, printRequestAttributeSet);
    exporter.setParameter((JRExporterParameter)JRPrintServiceExporterParameter.PRINT_SERVICE_ATTRIBUTE_SET, printServiceAttributeSet);
  ...
  @ResponseBody
  public void imprimirEstadoDeCuentaCXC(HttpServletResponse response, HttpSession session, @PathVariable("clienteId") String clienteId) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Long emisorId = Long.valueOf(Long.parseLong(session.getAttribute("SESSION_EMPRESA_ID").toString()));
      Connection db = this.dataSource.getConnection();
      InputStream reportfile = getClass().getResourceAsStream("/estado-de-cuenta-cxc/estado-de-cuenta-cxc.jasper");
  ...
  @ResponseBody
  public void imprimirEstadoDeCuentaCXCCanceladas(HttpServletResponse response, HttpSession session, @PathVariable("clienteId") String clienteId) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Long emisorId = Long.valueOf(Long.parseLong(session.getAttribute("SESSION_EMPRESA_ID").toString()));
      Connection db = this.dataSource.getConnection();
      InputStream reportfile = getClass().getResourceAsStream("/impresiones/cxc-canceladas/estado-de-cuenta-cxc.jasper");
  ...
  @ResponseBody
  public void imprimirProforma(HttpServletResponse response, HttpSession session, @PathVariable("factura_id") Long id, @RequestParam(name = "print", required = false) String print) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Long emisorId = Long.valueOf(Long.parseLong(session.getAttribute("SESSION_EMPRESA_ID").toString()));
  ...
  @ResponseBody
  public void imprimirReciboCXC(HttpServletResponse response, HttpSession session, @PathVariable("id") String id, @RequestParam(name = "print", required = false) String print) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Connection db = this.dataSource.getConnection();
      InputStream reportfile = null;
  ...
  @ResponseBody
  public void imprimirReciboCXCMasivo(HttpServletResponse response, HttpSession session, @PathVariable("id") String id, @RequestParam(name = "print", required = false) String print) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Connection db = this.dataSource.getConnection();
      InputStream reportfile = null;
  ...
  @ResponseBody
  public void imprimirCierreCaja(HttpServletResponse response, HttpSession session, @PathVariable("id") String id, @RequestParam(name = "resumen", required = false) String resumen) throws JRException, IOException, SQLException {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      Connection db = this.dataSource.getConnection();
      InputStream reportfile = null;
