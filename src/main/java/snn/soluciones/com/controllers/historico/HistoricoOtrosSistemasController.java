package snn.soluciones.com.controllers.historico;
...
public class HistoricoOtrosSistemasController {
  ...
  public String home(Model model, @RequestParam(name = "page", defaultValue = "0") int page, @RequestParam(name = "q", defaultValue = "") String q, HttpSession session) {
    if (session.getAttribute("SESSION_EMPRESA_ID") != null) {
      ...
      ListaDocumentos = this._historicoService.findAllByIdEmisorAndId(emisorId, q.toUpperCase(), (Pageable)pageRequest);
